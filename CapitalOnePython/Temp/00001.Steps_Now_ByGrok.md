...
Edge case trap: repeating prefix + unique suffix
───────────────────────────────────────────────
Pattern: "abcde" × n + "01234"
- Repeating cycle limits internal windows to cycle length (5 here)
- Longest window is often at the boundary / tail
- Real max = length of last repeating char + unique suffix
→ Here: last 'e' + "01234" = 6
Lesson: always consider cross-boundary windows — don't assume longest is in the middle.